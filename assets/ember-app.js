  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('ТехКартаL', 'i-i-s-kursovaya-gladkov-a-тех-карта', {
      ...
      чертеж: (0, _attributes.belongsTo)('i-i-s-kursovaya-gladkov-a-чертеж', 'Номер чертежа', {
        ...
        тчЗаявка: (0, _attributes.belongsTo)('i-i-s-kursovaya-gladkov-a-тч-заявка', '', {
          материалы: (0, _attributes.belongsTo)('i-i-s-kursovaya-gladkov-a-материалы', '', {
